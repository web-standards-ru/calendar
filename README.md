...
- Если событие заканчивается в полночь, то указать время 23:59.
- Если у события нет времени окончания, то написать примерное время, плюс 3-5 часов от времени начала.
